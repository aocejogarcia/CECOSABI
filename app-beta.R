...
fieldsMandatory <- c('nombre', 'municipio', 'nom_ins', 'horario', 'atn_01')
    ...
    '))), tags$form(id = "form",
                                  div(
                                    ...
                                    fluidRow(
                                      column(6, wellPanel(
                                        ...
                                        #          "Fecha de Captura:",
                                        #          value = Sys.Date(), # Establece la fecha actual por defecto
                                        #          format = "dd/mm/yyyy",
                                        #          language = "es"),
                                  ...
                                  shinyjs::hidden(
                                    div(
                                      ...
                                      actionButton("submit_another", "Enviar otra respuesta", class = "btn-link")
                                    )
                                  ),
                                  shinyjs::hidden(
...
server <- function(input, output, session) {
  ...
  observeEvent(input$submit, {
    ...
    tryCatch({
      ...
      #db <- DBI::dbConnect(RMySQL::MySQL(), dbname = 'dgssp_prueba', host = options()$mysql$host, 
      #                     port = options()$mysql$port, user = options()$mysql$user, 
      #                     password = options()$mysql$password
      #)
      db <- dbPool(drv = RMySQL::MySQL(), dbname = 'dgssp_prueba', host = options()$mysql$host, 
                           port = options()$mysql$port, user = options()$mysql$user, 
                           password = options()$mysql$password
      )
      ...
      atn2_142 <- input$atn2_142
      atn2_143<- input$atn2_143
      atn2_143fun<- input$atn2_143fun
      atn2_143h <- str_c(input[["atn2_143h"]], collapse = ', ')
      atn2_144<- input$atn2_144
      atn2_144fun<- input$atn2_144fun
      atn2_144h <- str_c(input[["atn2_144h"]], collapse = ', ')
      atn2_145<- input$atn2_145
      atn2_145fun<- input$atn2_145fun
      atn2_145h <- str_c(input[["atn2_145h"]], collapse = ', ')
      atn2_146<- input$atn2_146
      atn2_146fun<- input$atn2_146fun
      atn2_146h <- str_c(input[["atn2_146h"]], collapse = ', ')
      atn2_147<- input$atn2_147
      atn2_147fun<- input$atn2_147fun
      atn2_147h <- str_c(input[["atn2_147h"]], collapse = ', ')
      atn2_148<- input$atn2_148
      atn2_148fun<- input$atn2_148fun
      atn2_148h <- str_c(input[["atn2_148h"]], collapse = ', ')
      atn2_149<- input$atn2_149
      atn2_149fun<- input$atn2_149fun
      atn2_149h <- str_c(input[["atn2_149h"]], collapse = ', ')
      atn2_150<- input$atn2_150
      atn2_150fun<- input$atn2_150fun
      atn2_150h <- str_c(input[["atn2_150h"]], collapse = ', ')
      atn2_151<- input$atn2_151
      atn2_151fun<- input$atn2_151fun
      atn2_151h <- str_c(input[["atn2_151h"]], collapse = ', ')
      atn2_152<- input$atn2_152
      atn2_152fun<- input$atn2_152fun
      atn2_152h <- str_c(input[["atn2_152h"]], collapse = ', ')
      atn2_153<- input$atn2_153
      atn2_153fun<- input$atn2_153fun
      atn2_153h <- str_c(input[["atn2_153h"]], collapse = ', ')
      atn2_154<- input$atn2_154
      atn2_154fun<- input$atn2_154fun
      atn2_154h <- str_c(input[["atn2_154h"]], collapse = ', ')
      atn2_155<- input$atn2_155
      atn2_155fun<- input$atn2_155fun
      atn2_155h <- str_c(input[["atn2_155h"]], collapse = ', ')
      atn2_156<- input$atn2_156
      atn2_156fun<- input$atn2_156fun
      atn2_156h <- str_c(input[["atn2_156h"]], collapse = ', ')
      atn2_157<- input$atn2_157
      atn2_157fun<- input$atn2_157fun
      atn2_157h <- str_c(input[["atn2_157h"]], collapse = ', ')
      atn2_158<- input$atn2_158
      atn2_158fu<- input$atn2_158fu
      atn2_158fun<- input$atn2_158fun
      atn2_158h <- str_c(input[["atn2_158h"]], collapse = ', ')
      atn2_158nf<- input$atn2_158nf
      atn2_159<- input$atn2_159
      atn2_159fun<- input$atn2_159fun
      atn2_159h <- str_c(input[["atn2_159h"]], collapse = ', ')
      atn2_160<- input$atn2_160
      atn2_160fun<- input$atn2_160fun
      atn2_160h <- str_c(input[["atn2_160h"]], collapse = ', ')
      atn2_161<- input$atn2_161
      atn2_161fun<- input$atn2_161fun
      atn2_161h <- str_c(input[["atn2_161h"]], collapse = ', ')
      atn2_162<- input$atn2_162
      atn2_162fun<- input$atn2_162fun
      atn2_162h <- str_c(input[["atn2_162h"]], collapse = ', ')
      atn2_163<- input$atn2_163
      atn2_163a<- input$atn2_163a
      atn2_163fun<- input$atn2_163fun
      atn2_163h <- str_c(input[["atn2_163h"]], collapse = ', ')
      atn2_164<- input$atn2_164
      atn2_164a<- input$atn2_164a
      atn2_164fun<- input$atn2_164fun
      atn2_164h <- str_c(input[["atn2_164h"]], collapse = ', ')
      atn2_165<- input$atn2_165
      atn2_165a<- input$atn2_165a
      atn2_165fun<- input$atn2_165fun
      atn2_165h <- str_c(input[["atn2_165h"]], collapse = ', ')
      atn2_166<- input$atn2_166
      atn2_166a<- input$atn2_166a
      atn2_166fun<- input$atn2_166fun
      atn2_166h <- str_c(input[["atn2_166h"]], collapse = ', ')
      atn2_167<- input$atn2_167
      atn2_167a<- input$atn2_167a
      atn2_167fun<- input$atn2_167fun
      atn2_167h <- str_c(input[["atn2_167h"]], collapse = ', ')
      atn2_168<- input$atn2_168
      atn2_168a<- input$atn2_168a
      atn2_168fun<- input$atn2_168fun
      atn2_168h <- str_c(input[["atn2_168h"]], collapse = ', ')
      atn2_169<- input$atn2_169
      atn2_169a<- input$atn2_169a
      atn2_169fun<- input$atn2_169fun
      atn2_169h <- str_c(input[["atn2_169h"]], collapse = ', ')
      atn2_170<- input$atn2_170
      atn2_170a<- input$atn2_170a
      atn2_170fun<- input$atn2_170fun
      atn2_170h <- str_c(input[["atn2_170h"]], collapse = ', ')
      atn2_171<- input$atn2_171
      atn2_171a<- input$atn2_171a
      atn2_171fun<- input$atn2_171fun
      atn2_171h <- str_c(input[["atn2_171h"]], collapse = ', ')
      atn2_172<- input$atn2_172
      atn2_172a<- input$atn2_172a
      atn2_172fun<- input$atn2_172fun
      atn2_172h <- str_c(input[["atn2_172h"]], collapse = ', ')
      atn2_173<- input$atn2_173
      atn2_173a<- input$atn2_173a
      atn2_173fun<- input$atn2_173fun
      atn2_173h <- str_c(input[["atn2_173h"]], collapse = ', ')
      atn2_174<- input$atn2_174
      atn2_174a<- input$atn2_174a
      atn2_174fun<- input$atn2_174fun
      atn2_174h <- str_c(input[["atn2_174h"]], collapse = ', ')
      atn2_175<- input$atn2_175
      atn2_175a<- input$atn2_175a
      atn2_175fun<- input$atn2_175fun
      atn2_175h <- str_c(input[["atn2_175h"]], collapse = ', ')
      atn2_176<- input$atn2_176
      atn2_176a<- input$atn2_176a
      atn2_176fun<- input$atn2_176fun
      atn2_176h <- str_c(input[["atn2_176h"]], collapse = ', ')
      atn2_177<- input$atn2_177
      atn2_177a<- input$atn2_177a
      atn2_177fun<- input$atn2_177fun
      atn2_177h <- str_c(input[["atn2_177h"]], collapse = ', ')
      atn2_178<- input$atn2_178
      atn2_178a<- input$atn2_178a
      atn2_178fun<- input$atn2_178fun
      atn2_178h <- str_c(input[["atn2_178h"]], collapse = ', ')
      atn2_179<- input$atn2_179
      atn2_179a<- input$atn2_179a
      atn2_179fun<- input$atn2_179fun
      atn2_179h <- str_c(input[["atn2_179h"]], collapse = ', ')
      atn2_180<- input$atn2_180
      atn2_180fu<- input$atn2_180fu
      atn2_180nf<- input$atn2_180nf
      atn2_181<- input$atn2_181
      atn2_181fu<- input$atn2_181fu
      atn2_181nf<- input$atn2_181nf
      atn2_182<- input$atn2_182
      atn2_182fu<- input$atn2_182fu
      atn2_182nf<- input$atn2_182nf
      atn2_182t<- input$atn2_182t
      atn2_183<- input$atn2_183
      atn2_184<- input$atn2_184
      atn2_184fu<- input$atn2_184fu
      atn2_184fun<- input$atn2_184fun
      atn2_184h <- str_c(input[["atn2_184h"]], collapse = ', ')
      atn2_184nf<- input$atn2_184nf
      atn2_185<- input$atn2_185
      atn2_185a<- input$atn2_185a
      atn2_186 <- input$atn2_186
      atn2_186fu<- input$atn2_186fu
      atn2_186h <- str_c(input[["atn2_186h"]], collapse = ', ')
      atn2_186nf<- input$atn2_186nf
      
      
      
      datos1 <- data.frame(
        nombre = nombre,	dependencia = dependencia, municipio = municipio,	nom_ins = nom_ins,	tel = tel,	horario = horario,	atn_01 = atn_01,	atn2_01 = atn2_01,	atn2_01h = atn2_01h,	atn2_01m = atn2_01m,	atn2_01e = atn2_01e,	atn2_01con = atn2_01con,	atn2_01fun = atn2_01fun,	atn2_49 = atn2_49,	atn2_49h = atn2_49h,	atn2_49t = atn2_49t,	atn2_49fun = atn2_49fun,	atn2_03 = atn2_03,	atn2_03h = atn2_03h,	atn2_03q = atn2_03q,
        atn2_03qmi = atn2_03qmi,	atn2_03me = atn2_03me,	atn2_03e = atn2_03e,	atn2_03fun = atn2_03fun,	atn2_04 = atn2_04,	atn2_04h = atn2_04h,	atn2_04pm = atn2_04pm,	atn2_04fun = atn2_04fun,	atn2_05 = atn2_05,	atn2_05h = atn2_05h,	atn2_05pc = atn2_05pc,	atn2_05fun = atn2_05fun,	atn2_66 = atn2_66,	atn2_66h = atn2_66h,	atn2_66me = atn2_66me,	atn2_66m = atn2_66m,	atn2_66e = atn2_66e,	atn2_66con = atn2_66con,	atn2_66fun = atn2_66fun,	
        atn2_46 = atn2_46,	atn2_46e = atn2_46e,	atn2_46eq = atn2_46eq,	atn2_46est = atn2_46est,	atn2_46fun = atn2_46fun,	atn2_48 = atn2_48,	atn2_48h = atn2_48h,	atn2_48me = atn2_48me,	atn2_48m = atn2_48m,	atn2_48ps = atn2_48ps,	atn2_48e = atn2_48e,	atn2_48fun = atn2_48fun,	atn2_50 = atn2_50,	atn2_50h = atn2_50h,	atn2_50n = atn2_50n,	atn2_50fun = atn2_50fun,	atn2_85 = atn2_85,	atn2_85h = atn2_85h,	atn2_85e = atn2_85e,	atn2_85rf = atn2_85rf,	
        atn2_85fun = atn2_85fun,	atn2_107 = atn2_107,	atn2_02 = atn2_02,	atn2_02h = atn2_02h,	atn2_02me = atn2_02me,	atn2_02m = atn2_02m,	atn2_02e = atn2_02e,	atn2_02con = atn2_02con,	atn2_02fun = atn2_02fun,	atn2_108 = atn2_108,	atn2_108h = atn2_108h,	atn2_108me = atn2_108me,	atn2_108m = atn2_108m,	atn2_108e = atn2_108e,	atn2_108c = atn2_108c,	atn2_108fun = atn2_108fun,	atn2_54 = atn2_54,	atn2_54h = atn2_54h,	atn2_54me = atn2_54me,	atn2_54m = atn2_54m,
        atn2_54e = atn2_54e,	atn2_54con = atn2_54con,	atn2_54fun = atn2_54fun,	atn2_55 = atn2_55,	atn2_55h = atn2_55h,	atn2_55me = atn2_55me,	atn2_55m = atn2_55m,	atn2_55e = atn2_55e,	atn2_55con = atn2_55con,	atn2_55fun = atn2_55fun,	atn2_45 = atn2_45,	atn2_45h = atn2_45h,	atn2_45me = atn2_45me,	atn2_45m = atn2_45m,	atn2_45e = atn2_45e,	atn2_45con = atn2_45con,	atn2_45fun = atn2_45fun,	atn2_56 = atn2_56,	atn2_56h = atn2_56h,	atn2_56me = atn2_56me,	atn2_56m = atn2_56m,
        atn2_56e = atn2_56e,	atn2_56c = atn2_56c,	atn2_56fun = atn2_56fun,	atn2_57 = atn2_57,	atn2_57h = atn2_57h,	atn2_57me = atn2_57me,	atn2_57m = atn2_57m,	atn2_57e = atn2_57e,	atn2_57con = atn2_57con,	atn2_57fun = atn2_57fun,	atn2_60 = atn2_60,	atn2_60h = atn2_60h,	atn2_60me = atn2_60me,	atn2_60m = atn2_60m,	atn2_60e = atn2_60e,	atn2_60con = atn2_60con,	atn2_60fun = atn2_60fun,	atn2_61 = atn2_61,	atn2_61h = atn2_61h,	atn2_61me = atn2_61me,	atn2_61m = atn2_61m,	atn2_61e = atn2_61e,	atn2_61con = atn2_61con,
        atn2_61fun = atn2_61fun,	atn2_63 = atn2_63,	atn2_63h = atn2_63h,	atn2_63me = atn2_63me,	atn2_63m = atn2_63m,	atn2_63e = atn2_63e,	atn2_63con = atn2_63con,	atn2_63fun = atn2_63fun,	atn2_89 = atn2_89,	atn2_89h = atn2_89h,	atn2_89me = atn2_89me,	atn2_89m = atn2_89m,	atn2_89e = atn2_89e,	atn2_89con = atn2_89con,	atn2_89fun = atn2_89fun,	atn2_87 = atn2_87,	atn2_87me = atn2_87me,	atn2_87m = atn2_87m,	atn2_87e = atn2_87e,	atn2_87con = atn2_87con,	atn2_87fun = atn2_87fun,	atn2_113 = atn2_113,	atn2_113h = atn2_113h,
        atn2_113me = atn2_113me,	atn2_113m = atn2_113m,	atn2_113e = atn2_113e,	atn2_113c = atn2_113c,	atn2_113fun = atn2_113fun,	atn2_114 = atn2_114,	atn2_114h = atn2_114h,	atn2_114me = atn2_114me,	atn2_114m = atn2_114m,	atn2_114e = atn2_114e,	atn2_114c = atn2_114c,	atn2_114fun = atn2_114fun,	atn2_116 = atn2_116,	atn2_116h = atn2_116h,	atn2_116me = atn2_116me,	atn2_116m = atn2_116m,	atn2_116e = atn2_116e,	atn2_116c = atn2_116c,	atn2_116fun = atn2_116fun,	atn2_118 = atn2_118,	atn2_118h = atn2_118h,	atn2_118me = atn2_118me,
        atn2_118m = atn2_118m,	atn2_118e = atn2_118e,	atn2_118c = atn2_118c,	atn2_118fun = atn2_118fun,	atn2_119 = atn2_119,	atn2_119h = atn2_119h,	atn2_119me = atn2_119me,	atn2_119m = atn2_119m,	atn2_119e = atn2_119e,	atn2_119c = atn2_119c,	atn2_119fun = atn2_119fun,	atn2_120 = atn2_120,	atn2_120h = atn2_120h,	atn2_120me = atn2_120me,	atn2_120m = atn2_120m,	atn2_120e = atn2_120e,	atn2_120c = atn2_120c,	atn2_120fun = atn2_120fun,	atn2_121 = atn2_121,	atn2_121h = atn2_121h,	atn2_121me = atn2_121me,	atn2_121m = atn2_121m,
        atn2_121e = atn2_121e,	atn2_121c = atn2_121c,	atn2_121fun = atn2_121fun,	atn2_122 = atn2_122,	atn2_122h = atn2_122h,	atn2_122me = atn2_122me,	atn2_122m = atn2_122m,	atn2_122e = atn2_122e,	atn2_122c = atn2_122c,	atn2_122fun = atn2_122fun,	atn2_123 = atn2_123,	atn2_123h = atn2_123h,	atn2_123me = atn2_123me,	atn2_123m = atn2_123m,	atn2_123e = atn2_123e,	atn2_123c = atn2_123c,	atn2_123fun = atn2_123fun,	atn2_124 = atn2_124,	atn2_124h = atn2_124h
      )
      datos2 <- data.frame(
        nombre = nombre,	nom_ins = nom_ins,
        atn2_124me = atn2_124me,	atn2_124m = atn2_124m,	atn2_124e = atn2_124e,	atn2_124c = atn2_124c,	atn2_124fun = atn2_124fun,	atn2_125 = atn2_125,	atn2_125h = atn2_125h,	atn2_125me = atn2_125me,	atn2_125m = atn2_125m,	atn2_125e = atn2_125e,	atn2_125c = atn2_125c,	atn2_125fun = atn2_125fun,	atn2_126 = atn2_126,	atn2_126h = atn2_126h,	atn2_126me = atn2_126me,	atn2_126m = atn2_126m,	atn2_126e = atn2_126e,	atn2_126c = atn2_126c,	atn2_126fun = atn2_126fun,	atn2_127 = atn2_127,	atn2_127h = atn2_127h,	atn2_127me = atn2_127me,
        atn2_127m = atn2_127m,	atn2_127e = atn2_127e,	atn2_127c = atn2_127c,	atn2_127fun = atn2_127fun,	atn2_128 = atn2_128,	atn2_128h = atn2_128h,	atn2_128me = atn2_128me,	atn2_128m = atn2_128m,	atn2_128e = atn2_128e,	atn2_128c = atn2_128c,	atn2_128fun = atn2_128fun,	atn2_129 = atn2_129,	atn2_129h = atn2_129h,	atn2_129me = atn2_129me,	atn2_129m = atn2_129m,	atn2_129e = atn2_129e,	atn2_129c = atn2_129c,	atn2_129fun = atn2_129fun,	atn2_130 = atn2_130,	atn2_130h = atn2_130h,	atn2_130me = atn2_130me,	atn2_130m = atn2_130m,	atn2_130e = atn2_130e,
        atn2_130c = atn2_130c,	atn2_130fun = atn2_130fun,	atn2_131 = atn2_131,	atn2_131h = atn2_131h,	atn2_131me = atn2_131me,	atn2_131m = atn2_131m,	atn2_131e = atn2_131e,	atn2_131c = atn2_131c,	atn2_131fun = atn2_131fun,	atn2_133 = atn2_133,	atn2_133h = atn2_133h,	atn2_133me = atn2_133me,	atn2_133m = atn2_133m,	atn2_133e = atn2_133e,	atn2_133c = atn2_133c,	atn2_133fun = atn2_133fun,	atn2_134 = atn2_134,	atn2_134h = atn2_134h,	atn2_134me = atn2_134me,	atn2_134m = atn2_134m,	atn2_134e = atn2_134e,	atn2_134c = atn2_134c,	atn2_134fun = atn2_134fun,
        atn2_135 = atn2_135,	atn2_135h = atn2_135h,	atn2_135me = atn2_135me,	atn2_135m = atn2_135m,	atn2_135e = atn2_135e,	atn2_135c = atn2_135c,	atn2_135fun = atn2_135fun,	atn2_137 = atn2_137,	atn2_137h = atn2_137h,	atn2_137me = atn2_137me,	atn2_137m = atn2_137m,	atn2_137e = atn2_137e,	atn2_137c = atn2_137c,	atn2_137fun = atn2_137fun,	atn2_138 = atn2_138,	atn2_138h = atn2_138h,	atn2_138me = atn2_138me,	atn2_138m = atn2_138m,	atn2_138e = atn2_138e,	atn2_138c = atn2_138c,	atn2_138fun = atn2_138fun,	atn2_139 = atn2_139,	atn2_139h = atn2_139h,	atn2_139me = atn2_139me,
        atn2_139m = atn2_139m,	atn2_139e = atn2_139e,	atn2_139c = atn2_139c,	atn2_139fun = atn2_139fun,	atn2_140 = atn2_140,	atn2_140h = atn2_140h,	atn2_140me = atn2_140me,	atn2_140m = atn2_140m,	atn2_140e = atn2_140e,	atn2_140c = atn2_140c,	atn2_140fun = atn2_140fun,	atn2_141 = atn2_141,	atn2_141h = atn2_141h,	atn2_141me = atn2_141me,	atn2_141m = atn2_141m,	atn2_141e = atn2_141e,	atn2_141c = atn2_141c,	atn2_141fun = atn2_141fun,	atn2_06 = atn2_06,	atn2_06me = atn2_06me,	atn2_06m = atn2_06m,	atn2_06e = atn2_06e,	atn2_06fun = atn2_06fun,	atn2_06h = atn2_06h,	atn2_06tr = atn2_06tr,
        atn2_06cam = atn2_06cam,	atn2_06ch = atn2_06ch,	atn2_06ais = atn2_06ais,	atn2_07 = atn2_07,	atn2_07h = atn2_07h,	atn2_07me = atn2_07me,	atn2_07m = atn2_07m,	atn2_07e = atn2_07e,	atn2_07pm = atn2_07pm,	atn2_07fun = atn2_07fun,	atn2_08 = atn2_08,	atn2_08h = atn2_08h,	atn2_08me = atn2_08me,	atn2_08m = atn2_08m,	atn2_08e = atn2_08e,	atn2_08op = atn2_08op,	atn2_08cam = atn2_08cam,	atn2_08fun = atn2_08fun,	atn2_11 = atn2_11,	atn2_11h = atn2_11h,	atn2_11me = atn2_11me,	atn2_11m = atn2_11m,	atn2_11e = atn2_11e,	atn2_11op = atn2_11op,	atn2_11cam = atn2_11cam,	atn2_11fun = atn2_11fun,
        atn2_09 = atn2_09,	atn2_09h = atn2_09h,	atn2_09e = atn2_09e,	atn2_09fun = atn2_09fun,	atn2_10 = atn2_10,	atn2_10h = atn2_10h,	atn2_10me = atn2_10me,	atn2_10m = atn2_10m,	atn2_10e = atn2_10e,	atn2_10op = atn2_10op,	atn2_10fun = atn2_10fun,	atn2_10q = atn2_10q,	atn2_12 = atn2_12,	atn2_12h = atn2_12h,	atn2_12me = atn2_12me,	atn2_12m = atn2_12m,	atn2_12e = atn2_12e,	atn2_12fun = atn2_12fun,	atn2_12op = atn2_12op,	atn2_12q = atn2_12q,	atn2_84 = atn2_84,	atn2_84h = atn2_84h,	atn2_84me = atn2_84me,	atn2_84m = atn2_84m,	atn2_84fun = atn2_84fun,	atn2_84e = atn2_84e,	atn2_53 = atn2_53,
        atn2_53h = atn2_53h,	atn2_53me = atn2_53me,	atn2_53m = atn2_53m,	atn2_53fun = atn2_53fun,	atn2_53e = atn2_53e,	atn2_62 = atn2_62,	atn2_62me = atn2_62me,	atn2_62m = atn2_62m,	atn2_62e = atn2_62e,	atn2_62fun = atn2_62fun,	atn2_64 = atn2_64,	atn2_64h = atn2_64h,	atn2_64me = atn2_64me,	atn2_64m = atn2_64m,	atn2_64e = atn2_64e,	atn2_64fun = atn2_64fun,	atn2_65 = atn2_65,	atn2_65h = atn2_65h,	atn2_65me = atn2_65me,	atn2_65m = atn2_65m,	atn2_65e = atn2_65e,	atn2_65con = atn2_65con,	atn2_65fun = atn2_65fun,	atn2_67 = atn2_67,	atn2_67h = atn2_67h,	atn2_67me = atn2_67me,	atn2_67m = atn2_67m,
        atn2_67e = atn2_67e,	atn2_67con = atn2_67con,	atn2_67fun = atn2_67fun,	atn2_69 = atn2_69,	atn2_69h = atn2_69h,	atn2_69me = atn2_69me,	atn2_69m = atn2_69m,	atn2_69e = atn2_69e,	atn2_69fun = atn2_69fun
      )
      datos3 <- data.frame(
        nombre = nombre,	nom_ins = nom_ins,
        atn2_88 = atn2_88,	atn2_88h = atn2_88h,	atn2_88me = atn2_88me,	atn2_88m = atn2_88m,	atn2_88e = atn2_88e,	atn2_88fun = atn2_88fun,	atn2_47 = atn2_47,	atn2_47h = atn2_47h,	atn2_47o = atn2_47o,	atn2_47me = atn2_47me,	atn2_47m = atn2_47m,	atn2_47e = atn2_47e,	atn2_47fun = atn2_47fun,	atn2_59 = atn2_59,	atn2_59h = atn2_59h,	atn2_59ps = atn2_59ps,	atn2_59fun = atn2_59fun,	atn2_51 = atn2_51,	atn2_51h = atn2_51h,	atn2_51a = atn2_51a,	atn2_51fun = atn2_51fun,	atn2_52 = atn2_52,	atn2_52h = atn2_52h,	atn2_52a = atn2_52a,	atn2_52fun = atn2_52fun,	atn2_70 = atn2_70,	atn2_70h = atn2_70h,	atn2_70me = atn2_70me,	
        atn2_70m = atn2_70m,	atn2_70e = atn2_70e,	atn2_70pm = atn2_70pm,	atn2_70fun = atn2_70fun,	atn2_68 = atn2_68,	atn2_68h = atn2_68h,	atn2_68me = atn2_68me,	atn2_68m = atn2_68m,	atn2_68ft = atn2_68ft,	atn2_68e = atn2_68e,	atn2_68fun = atn2_68fun,	atn2_15 = atn2_15,	atn2_15h = atn2_15h,	atn2_15pm = atn2_15pm,	atn2_15carg = atn2_15carg,	atn2_15ah = atn2_15ah,	atn2_15fun = atn2_15fun,	atn2_15d = atn2_15d,	atn2_23 = atn2_23,	atn2_23h = atn2_23h,	atn2_23fun = atn2_23fun,	atn2_23pm = atn2_23pm,	atn2_16 = atn2_16,	atn2_16h = atn2_16h,	atn2_16pm = atn2_16pm,	atn2_16fun = atn2_16fun,	atn2_22 = atn2_22,	atn2_22h = atn2_22h,
        atn2_22pm = atn2_22pm,	atn2_22i = atn2_22i,	atn2_22fun = atn2_22fun,	atn2_17 = atn2_17,	atn2_17h = atn2_17h,	atn2_17pm = atn2_17pm,	atn2_17fun = atn2_17fun,	atn2_18 = atn2_18,	atn2_18h = atn2_18h,	atn2_18pm = atn2_18pm,	atn2_18fun = atn2_18fun,	atn2_20 = atn2_20,	atn2_20h = atn2_20h,	atn2_20pm = atn2_20pm,	atn2_20fun = atn2_20fun,	atn2_19 = atn2_19,	atn2_19h = atn2_19h,	atn2_19pm = atn2_19pm,	atn2_19se = atn2_19se,	atn2_19fun = atn2_19fun,	atn2_21 = atn2_21,	atn2_21baf = atn2_21baf,	atn2_21ban = atn2_21ban,	atn2_21fun = atn2_21fun,	atn2_24 = atn2_24,	atn2_24pm = atn2_24pm,	atn2_24fun = atn2_24fun,	atn2_25 = atn2_25,
        atn2_25m = atn2_25m,	atn2_25fun = atn2_25fun,	atn2_26 = atn2_26,	atn2_27 = atn2_27,	atn2_28 = atn2_28,	atn2_29 = atn2_29,	atn2_30 = atn2_30,	atn2_31 = atn2_31,	atn2_32 = atn2_32,	atn2_33 = atn2_33,	atn2_34 = atn2_34,	atn2_35 = atn2_35,	atn2_40 = atn2_40,	atn2_36 = atn2_36,	atn2_37 = atn2_37,	atn2_38 = atn2_38,	atn2_39 = atn2_39,	atn2_41 = atn2_41,	atn2_42 = atn2_42,	atn2_106 = atn2_106,	atn2_95 = atn2_95,	atn2_95sr = atn2_95sr,	atn2_95fu = atn2_95fu,	atn2_95nf = atn2_95nf,	atn2_95fun = atn2_95fun,	atn2_97 = atn2_97,	atn2_97fu = atn2_97fu,	atn2_97nnf = atn2_97nnf,	atn2_98 = atn2_98,	atn2_98fu = atn2_98fu,	atn2_98nf = atn2_98nf,
        atn2_99 = atn2_99,	atn2_99fu = atn2_99fu,	atn2_99nf = atn2_99nf,	atn2_100 = atn2_100,	atn2_100fu = atn2_100fu,	atn2_100nf = atn2_100nf,	atn2_101 = atn2_101,	atn2_101fu = atn2_101fu,	atn2_101nf = atn2_101nf,	atn2_102 = atn2_102,	atn2_102fu = atn2_102fu,	atn2_102nf = atn2_102nf,	atn2_103 = atn2_103,	atn2_103fu = atn2_103fu,	atn2_103nf = atn2_103nf,	atn2_104 = atn2_104,	atn2_104fu = atn2_104fu,	atn2_104nf = atn2_104nf,	atn2_71 = atn2_71,	atn2_71h = atn2_71h,	atn2_71pc = atn2_71pc,	atn2_71fu = atn2_71fu,	atn2_71nf = atn2_71nf,	atn2_72 = atn2_72,	atn2_72h = atn2_72h,	atn2_72pc = atn2_72pc,	atn2_72fu = atn2_72fu,	atn2_72nf = atn2_72nf,
        atn2_72fun = atn2_72fun,	atn2_73 = atn2_73,	atn2_73h = atn2_73h,	atn2_73pc = atn2_73pc,	atn2_73fu = atn2_73fu,	atn2_73nf = atn2_73nf,	atn2_77 = atn2_77,	atn2_77h = atn2_77h,	atn2_77pc = atn2_77pc,	atn2_77es = atn2_77es,	atn2_77fu = atn2_77fu,	atn2_77nf = atn2_77nf,	atn2_79 = atn2_79,	atn2_79h = atn2_79h,	atn2_79pc = atn2_79pc,	atn2_79fu = atn2_79fu,	atn2_79nf = atn2_79nf,	atn2_83 = atn2_83,	atn2_83h = atn2_83h,	atn2_83pc = atn2_83pc,	atn2_83fu = atn2_83fu,	atn2_83nf = atn2_83nf,	atn2_74 = atn2_74,	atn2_74h = atn2_74h,	atn2_74me = atn2_74me,	atn2_74m = atn2_74m,	atn2_74e = atn2_74e,	atn2_74fu = atn2_74fu,	atn2_74nf = atn2_74nf,	atn2_75 = atn2_75,
        atn2_75h = atn2_75h,	atn2_75me = atn2_75me,	atn2_75m = atn2_75m,	atn2_75e = atn2_75e,	atn2_75fu = atn2_75fu,	atn2_75nf = atn2_75nf,	atn2_76 = atn2_76,	atn2_76h = atn2_76h,	atn2_76me = atn2_76me,	atn2_76m = atn2_76m,	atn2_76e = atn2_76e,	atn2_76fu = atn2_76fu,	atn2_76nf = atn2_76nf,	atn2_78 = atn2_78,	atn2_78h = atn2_78h,	atn2_78me = atn2_78me,	atn2_78m = atn2_78m,	atn2_78e = atn2_78e,	atn2_78es = atn2_78es,	atn2_78fu = atn2_78fu,	atn2_78nf = atn2_78nf,	atn2_80 = atn2_80,	atn2_80h = atn2_80h,	atn2_80me = atn2_80me,	atn2_80m = atn2_80m,	atn2_80e = atn2_80e,	atn2_80fu = atn2_80fu,	atn2_80nf = atn2_80nf,	atn2_81 = atn2_81,	atn2_81h = atn2_81h,	atn2_81me = atn2_81me,
        atn2_81m = atn2_81m,	atn2_81e = atn2_81e,	atn2_81aud = atn2_81aud,	atn2_81fu = atn2_81fu,	atn2_81nf = atn2_81nf                     
      )
      datos4 <- data.frame(
        nombre = nombre,	nom_ins = nom_ins,
        atn2_82 = atn2_82,	atn2_82h = atn2_82h,	atn2_82me = atn2_82me,	atn2_82m = atn2_82m,	atn2_82e = atn2_82e,	atn2_82ec = atn2_82ec,	atn2_82fu = atn2_82fu,	atn2_82nf = atn2_82nf,	atn2_44 = atn2_44,	atn2_44h = atn2_44h,	atn2_44me = atn2_44me,	atn2_44m = atn2_44m,	atn2_44e = atn2_44e,	atn2_44con = atn2_44con,	atn2_44fun = atn2_44fun,	atn2_13 = atn2_13,	atn2_13h = atn2_13h,	atn2_13me = atn2_13me,	atn2_13m = atn2_13m,	atn2_13e = atn2_13e,	atn2_13op = atn2_13op,	atn2_13fun = atn2_13fun,	atn2_13ch = atn2_13ch,	atn2_14 = atn2_14,	atn2_14h = atn2_14h,	atn2_14me = atn2_14me,	atn2_14m = atn2_14m,	atn2_14e = atn2_14e,	atn2_14op = atn2_14op,	atn2_14fun = atn2_14fun,	atn2_14q = atn2_14q,
        atn2_14qt = atn2_14qt,	atn2_105 = atn2_105,	atn2_96 = atn2_96,	atn2_96sr = atn2_96sr,	atn2_96fu = atn2_96fu,	atn2_96nf = atn2_96nf,	atn2_96fun = atn2_96fun,	pve_88 = pve_88,	pve_88fu = pve_88fu,	pve_88nf = pve_88nf,	pve_89 = pve_89,	pve_89fu = pve_89fu,	pve_89nf = pve_89nf,	pve_90 = pve_90,	pve_90fu = pve_90fu,	pve_90nf = pve_90nf,	pve_91 = pve_91,	pve_91fu = pve_91fu,	pve_91nf = pve_91nf,	pve_92 = pve_92,	pve_92fu = pve_92fu,	pve_92nf = pve_92nf,	pve_93 = pve_93,	pve_93fu = pve_93fu,	pve_93nf = pve_93nf,	pve_94 = pve_94,	pve_94fu = pve_94fu,	pve_94nf = pve_94nf,	atn2_142 = atn2_142,	atn2_143 = atn2_143,	atn2_143fun = atn2_143fun,	atn2_143h = atn2_143h,	atn2_144 = atn2_144,
        atn2_144fun = atn2_144fun,	atn2_144h = atn2_144h,	atn2_145 = atn2_145,	atn2_145fun = atn2_145fun,	atn2_145h = atn2_145h,	atn2_146 = atn2_146,	atn2_146fun = atn2_146fun,	atn2_146h = atn2_146h,	atn2_147 = atn2_147,	atn2_147fun = atn2_147fun,	atn2_147h = atn2_147h,	atn2_148 = atn2_148,	atn2_148fun = atn2_148fun,	atn2_148h = atn2_148h,	atn2_149 = atn2_149,	atn2_149fun = atn2_149fun,	atn2_149h = atn2_149h,	atn2_150 = atn2_150,	atn2_150fun = atn2_150fun,	atn2_150h = atn2_150h,	atn2_151 = atn2_151,	atn2_151fun = atn2_151fun,	atn2_151h = atn2_151h,	atn2_152 = atn2_152,	atn2_152fun = atn2_152fun,	atn2_152h = atn2_152h,	atn2_153 = atn2_153,	atn2_153fun = atn2_153fun,	atn2_153h = atn2_153h,
        atn2_154 = atn2_154,	atn2_154fun = atn2_154fun,	atn2_154h = atn2_154h,	atn2_155 = atn2_155,	atn2_155fun = atn2_155fun,	atn2_155h = atn2_155h,	atn2_156 = atn2_156,	atn2_156fun = atn2_156fun,	atn2_156h = atn2_156h,	atn2_157 = atn2_157,	atn2_157fun = atn2_157fun,	atn2_157h = atn2_157h,	atn2_158 = atn2_158,	atn2_158fu = atn2_158fu,	atn2_158fun = atn2_158fun,	atn2_158h = atn2_158h,	atn2_158nf = atn2_158nf,	atn2_159 = atn2_159,	atn2_159fun = atn2_159fun,	atn2_159h = atn2_159h,	atn2_160 = atn2_160,	atn2_160fun = atn2_160fun,	atn2_160h = atn2_160h,	atn2_161 = atn2_161,	atn2_161fun = atn2_161fun,	atn2_161h = atn2_161h,	atn2_162 = atn2_162,	atn2_162fun = atn2_162fun,	atn2_162h = atn2_162h,	atn2_163 = atn2_163,
        atn2_163a = atn2_163a,	atn2_163fun = atn2_163fun,	atn2_163h = atn2_163h,	atn2_164 = atn2_164,	atn2_164a = atn2_164a,	atn2_164fun = atn2_164fun,	atn2_164h = atn2_164h,	atn2_165 = atn2_165,	atn2_165a = atn2_165a,	atn2_165fun = atn2_165fun,	atn2_165h = atn2_165h,	atn2_166 = atn2_166,	atn2_166a = atn2_166a,	atn2_166fun = atn2_166fun,	atn2_166h = atn2_166h,	atn2_167 = atn2_167,	atn2_167a = atn2_167a,	atn2_167fun = atn2_167fun,	atn2_167h = atn2_167h,	atn2_168 = atn2_168,	atn2_168a = atn2_168a,	atn2_168fun = atn2_168fun,	atn2_168h = atn2_168h,	atn2_169 = atn2_169,	atn2_169a = atn2_169a,	atn2_169fun = atn2_169fun,	atn2_169h = atn2_169h,	atn2_170 = atn2_170,	atn2_170a = atn2_170a,	atn2_170fun = atn2_170fun,	atn2_170h = atn2_170h,
        atn2_171 = atn2_171,	atn2_171a = atn2_171a,	atn2_171fun = atn2_171fun,	atn2_171h = atn2_171h,	
        atn2_172 = atn2_172,	atn2_172a = atn2_172a ,	atn2_172fun = atn2_172fun,	atn2_172h = atn2_172h,
        atn2_173 = atn2_173,	atn2_173a = atn2_173a,
        atn2_173fun = atn2_173fun,	atn2_173h = atn2_173h,	atn2_174 = atn2_174,	atn2_174a = atn2_174a,	atn2_174fun = atn2_174fun,	atn2_174h = atn2_174h,	atn2_175 = atn2_175,	atn2_175a = atn2_175a,	atn2_175fun = atn2_175fun,	atn2_175h = atn2_175h,	atn2_176 = atn2_176,	atn2_176a = atn2_176a,	atn2_176fun = atn2_176fun,	atn2_176h = atn2_176h,	atn2_177 = atn2_177,	atn2_177a = atn2_177a,	atn2_177fun = atn2_177fun,	atn2_177h = atn2_177h,	atn2_178 = atn2_178,	atn2_178a = atn2_178a,	atn2_178fun = atn2_178fun,
        atn2_178h = atn2_178h,	atn2_179 = atn2_179,	atn2_179a = atn2_179a,	atn2_179fun = atn2_179fun,	atn2_179h = atn2_179h,	atn2_180 = atn2_180,	atn2_180fu = atn2_180fu,	atn2_180nf = atn2_180nf,	atn2_181 = atn2_181,	atn2_181fu = atn2_181fu,	atn2_181nf = atn2_181nf,	atn2_182 = atn2_182,	atn2_182fu = atn2_182fu,	atn2_182nf = atn2_182nf,	atn2_182t = atn2_182t,	atn2_183 = atn2_183,	atn2_184 = atn2_184,	atn2_184fu = atn2_184fu,	atn2_184fun = atn2_184fun,	atn2_184h = atn2_184h,	atn2_184nf = atn2_184nf,	atn2_185 = atn2_185,	atn2_185a = atn2_185a,	atn2_186 = atn2_186,	atn2_186fu = atn2_186fu,	atn2_186h = atn2_186h,	atn2_186nf = atn2_186nf,
        fecha = Sys.time()
      )
      
      pool::dbWriteTable(conn = db, name = 'respuestas1', value = datos1, row.names = FALSE, append = TRUE, overwrite = FALSE)
      pool::dbWriteTable(conn = db, name = 'respuestas2', value = datos2, row.names = FALSE, append = TRUE, overwrite = FALSE)
      pool::dbWriteTable(conn = db, name = 'respuestas3', value = datos3, row.names = FALSE, append = TRUE, overwrite = FALSE)
      pool::dbWriteTable(conn = db, name = 'respuestas4', value = datos4, row.names = FALSE, append = TRUE, overwrite = FALSE)
